...
a=new g.PZ(this.player,this);g.I(this,a);a.xa(this.Fh.element);this.rr=new g.V({F:"div",L:"ytp-miniplayer-controls"});g.I(this,this.rr);this.rr.xa(this.Fh.element);this.P(this.rr.element,"click",this.FC);var b=new g.V({F:"div",L:"ytp-miniplayer-button-container"});g.I(this,b);b.xa(this.rr.element);a=new g.V({F:"div",L:"ytp-miniplayer-play-button-container"});g.I(this,a);a.xa(this.rr.element);var c=new g.V({F:"div",L:"ytp-miniplayer-button-container"});g.I(this,c);c.xa(this.rr.element);this.xQ=new g.QL(this.player,
this,!1);g.I(this,this.xQ);this.xQ.xa(b.element);b=new g.OL(this.player,this);g.I(this,b);b.xa(a.element);this.nextButton=new g.QL(this.player,this,!0);g.I(this,this.nextButton);this.nextButton.xa(c.element);this.Ih=new g.eN(this.player,this);g.I(this,this.Ih);this.Ih.xa(this.Fh.element);this.vc=new g.aM(this.player,this);g.I(this,this.vc);g.SI(this.player,this.vc.element,4);this.vC=new g.V({F:"div",L:"ytp-miniplayer-buttons"});g.I(this,this.vC);g.SI(this.player,this.vC.element,4);a=new g.V({F:"button",
Ba:["ytp-miniplayer-close-button","ytp-button"],T:{"aria-label":"Close"},R:[g.tG()]});g.I(this,a);a.xa(this.vC.element);this.P(a.element,"click",this.Nj);a=new g.V({F:"button",Ba:["ytp-miniplayer-replay-button","ytp-button"],T:{"aria-label":"Close"},R:[g.zG()]});g.I(this,a);a.xa(this.vC.element);this.P(a.element,"click",this.BZ);this.P(this.player,"presentingplayerstatechange",this.Wc);this.P(this.player,"appresize",this.vb);this.P(this.player,"fullscreentoggled",this.vb);this.vb()};
...
g.k.BZ=function(){this.player.playVideo()};
